...
class GraphicDisplay(tk.Tk):
    def __init__(self, agent):
        ...
        self.text_reward(4, 4, "R : 10.0")
        self.text_reward(1, 3, "R : -3.0")
        self.text_reward(2, 1, "R : -3.0")
    ...
    def draw_from_policy(self, policy_table):
        ...
        for i in range(HEIGHT):
            for j in range(WIDTH):
                ...
                policy_str = "%d : %s" % (haha, policy_table[i][j])
                print(policy_str)
                haha+=1
        print()
...
class Env:
    def __init__(self):
        ...
        self.reward[4][4] = 10  # reward 1 for circle
        self.reward[2][1] = -3  # reward -1 for triangle
        self.reward[1][3] = -3  # reward -1 for triangle
        self.all_state = []
