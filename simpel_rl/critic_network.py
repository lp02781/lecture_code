...
model_dir_critic = os.path.join(os.path.split(os.path.realpath(__file__))[0], 'model','critic')
...
class CriticNetwork:
	...
	def load_network(self):
		...
		checkpoint = tf.train.get_checkpoint_state(model_dir_critic)
	...
	def save_network(self,time_step):
		...
		self.saver.save(self.sess, os.path.join(model_dir_critic, 'critic-network'), global_step=time_step)
